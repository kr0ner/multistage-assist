...
AREA_PHRASE_PATTERNS = {
    "light": [
        ...
        ("Mach {device} in {area} in 5 Minuten an", "DelayedControl", {"command": "on"}),
        ("Mach {device} in {area} um 15 Uhr an", "DelayedControl", {"command": "on"}),
        ("Mach {device} in {area} um 15 Uhr aus", "DelayedControl", {"command": "off"}),
    ],
    "cover": [
        # === Cover Open ===
